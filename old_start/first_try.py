# Funck Fact : You can use RPG to destroy an ant, but it's expensive
# scrapy and pandas are not mandatory 
# Learning : cloudfare 403, k-n-o-c-k k-n-o-c-k k-n-o-c-k o-p-e-n t-h-e d-o-o-r ! 
# Door is closed, so look through the window
